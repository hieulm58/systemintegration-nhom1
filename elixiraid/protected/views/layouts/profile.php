								...
								<div class="user_heading">
									<div class="row">
										<div class="col-sm-2 hidden-xs">
											<img src="<?php echo yii::app()->request->baseUrl; ?>img/user_avatar_lg.png" alt="" class="img-thumbnail user_avatar">
										</div>
										<div class="col-sm-10">
											...
											<form class="form-horizontal user_form">
												...
												<div class="form-group">
													...
													<div class="col-sm-10 editable">
														<p class="form-control-static">jSmith</p>
												...
												<div class="form-group">
													...
													<div class="col-sm-10 editable">
														<p class="form-control-static">23/10/1974</p>
														<div class="hidden_control">
...
<!--												<div class="form-group">
													...
													<div class="col-sm-10 editable">
														<p class="form-control-static">jsmith@example.com</p>
														<div class="hidden_control">
...
<!--												<div class="form-group">
													...
													<div class="col-sm-10 editable">
														<p class="form-control-static">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi consequatur modi provident accusamus qui eligendi aut minima sit obcaecati odio nam tempora at exercitationem totam eos animi temporibus earum. Aperiam.</p>
														<div class="hidden_control">
				...
				<ul id="text_nav_side_fixed">
					...
					<li>
						...
						<ul>
							...
							<li class="link_active"><a href="user_profile.html">User profile</a></li>
						</ul>
					</li>				
				</ul>
			</div>
