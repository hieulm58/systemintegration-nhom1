...
class Hospitalregistration extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('hospitalname', 'match', 'pattern' => '/^[A-Za-z0-9]+$/u', 'message' => 'Invalid hospital name.Avoid special characters($,@,_ etc..)'),
             array('contactperson', 'match', 'pattern' => '/^[A-Za-z0-9]+$/u', 'message' => 'Name.Avoid special characters($,@,_ etc..)'),
        );
    }
